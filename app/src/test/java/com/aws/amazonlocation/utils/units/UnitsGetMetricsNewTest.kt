...
class UnitsGetMetricsNewTest : BaseTest() {
    ...
    fun getMetricsSuccess() {
        ...
        Assert.assertTrue(TEST_FAILED_DUE_TO_INCORRECT_DATA, result == UNIT_METRICS_M_OUTPUT_3)
        result = Units.getMetrics(context, UNIT_METRICS_M_INPUT_2, true)
        Assert.assertTrue(TEST_FAILED_DUE_TO_INCORRECT_DATA, result == UNIT_METRICS_M_OUTPUT_2)
        result = Units.getMetrics(context, UNIT_METRICS_I_INPUT_1, false)
        Assert.assertTrue(TEST_FAILED_DUE_TO_INCORRECT_DATA, result == UNIT_METRICS_I_OUTPUT_3)
        result = Units.getMetrics(context, UNIT_METRICS_I_INPUT_2, false)

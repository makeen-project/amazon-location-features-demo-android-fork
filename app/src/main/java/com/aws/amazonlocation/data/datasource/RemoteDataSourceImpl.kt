...
class RemoteDataSourceImpl(var mContext: Context, var mAWSLocationHelper: AWSLocationHelper) :
    ...
    override suspend fun evaluateGeofence(
        ...
        val response =
            mAWSLocationHelper.evaluateGeofence(trackerName, position1, position2, position3, position4, position5, position6, position7, position8, position9, position10, deviceId, date)
        mTrackingInterface.success(response)
    }

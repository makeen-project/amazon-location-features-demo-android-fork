...
object EventType {
    ...
    const val SAMPLE_CLICKED = "SAMPLE_CLICKED"
    const val SAMPLE_FILTERS_APPLIED = "SAMPLE_FILTERS_APPLIED"
    const val LAUNCH_STACK_BUTTON_CLICKED = "LAUNCH_STACK_BUTTON_CLICKED"
    const val CLONE_COMMAND_COPIED = "CLONE_COMMAND_COPIED"
    const val CODE_SNIPPET_COPIED = "CODE_SNIPPET_COPIED"
    const val CODE_SNIPPET_TAB_CHANGED = "CODE_SNIPPET_TAB_CHANGED"
    const val OPEN_IN_GITHUB_BUTTON_CLICKED = "OPEN_IN_GITHUB_BUTTON_CLICKED"
    const val SETUP_CLICKED = "SETUP_CLICKED"
    const val SETUP_COPIED = "SETUP_COPIED"
    const val CLEANUP_CLICKED = "CLEANUP_CLICKED"
